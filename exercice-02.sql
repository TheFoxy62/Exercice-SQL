...
VALUES ('Promo 2023','La promo de l`année 2023','2023/05/15', NULL);
-- Exo 2.3
...
UPDATE `tag` 
SET `description` = 'Le HTML est un language de structuration de donnée' 
WHERE `tag`.`id` = 1; 
-- Exo 2.5
...
-- - projet : Dicta quia at qui 6
DELETE FROM student_tag
WHERE `student_tag`.`student_id` = 16 AND `project_tag`.`project_id` = 6;
